...
class InferLamaWidget(core.CWorkflowTaskWidget):
    ...
    def __init__(self, param, parent):
        ...
        #self.combo_method.setCurrentIndex(0 if self.parameters.method == "default" else 1)
        ...
        self.ini_resolution = pyqtutils.append_double_spin(self.gridLayout, "Initial image resolution (%):", self.parameters.ini_res,
                                                    min=1., max=100., step=1, decimals=1)
        

        # Number of iteration
        self.iterations = pyqtutils.append_double_spin(self.gridLayout, "Iterations:", self.parameters.iter,
    ...
    def onApply(self):
        ...
        #self.combo_method.setCurrentText(self.parameters.model)
